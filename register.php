				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form class="user needs-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" novalidate>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input name="cpassword" type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password">
									</div>
								</div>
